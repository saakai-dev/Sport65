...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    favorite: function favorite(blog) {
      var _this = this;

      axios.blog('/favorite/' + blog).then(function (response) {
        return _this.isFavorited = true;
      })["catch"](function (response) {
        return console.log(response.data);
      });
    },
    unFavorite: function unFavorite(blog) {
      var _this2 = this;

      axios.blog('/unfavorite/' + blog).then(function (response) {
          ...
          "a",
          {
            ...
            on: {
              click: function($event) {
                ...
                return _vm.unFavorite(_vm.blog)
              }
            }
          },
